...
function prepareDevelopment() {
  ...
  const nlsPath = path.join(workspaceFolder, 'package.nls.json');
  const devPackagePath = path.join(workspaceFolder, 'package.dev.json');
  ...
  console.log('✅ Created package.dev.json for development');
  console.log('📝 Use this file for debugging in VSCode');
}
